...
const UpCompany = (props)=>{
    ...
    const update = (e) =>     {
        ...
        ApiService.UpdateCompany(id,companyState).then( res=>{
                console.log(res.data);
    ...
    return <div>
        ...
        <Col md="8">
            <Card>
                ...
                <CardFooter>
                    <Button   onClick={update}  className="btn-fill" color="primary" type="submit">
                        Update
                    </Button>
                </CardFooter>
            </Card>
